    ...
    <Box>
      ...
      >
        ...
        >
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5, '& > *': { display: 'flex', alignItems: 'center', gap: 2, p: 2, borderRadius: '8px', transition: 'all 0.2s ease-in-out', '&:hover': { bgcolor: 'action.hover' } } }}>
            <Box>
              <PersonIcon sx={{ color: 'primary.main', fontSize: 28 }} />
              <Typography variant="body1">William Fernandez</Typography>
            </Box>

            <Link component="button" onClick={handleEmailClick} sx={{ textDecoration: 'none', color: 'text.primary', '&:hover': { color: 'primary.main' } }}>
              <EmailIcon sx={{ color: 'primary.main', fontSize: 28 }} />
              <Typography variant="body1">bcnwilliam@yahoo.com</Typography>
            </Link>

            <Link component="button" onClick={handlePhoneClick} sx={{ textDecoration: 'none', color: 'text.primary', '&:hover': { color: 'primary.main' } }}>
              <PhoneIcon sx={{ color: 'primary.main', fontSize: 28 }} />
              <Typography variant="body1">07405716917</Typography>
            </Link>
          </Box>
        </Box>
      </Modal>
